...
typedef Eigen::Matrix<double, 56, 56> Mat5656;
...
typedef Eigen::Matrix<double, 6 + 5*5*2 + 1, 6 + 5*5*2 + 1> MatMFMF;
...
typedef Eigen::Matrix<float, 1, 56> Mat156f;
typedef Eigen::Matrix<float, 1, 16> Mat116f;
...
//for multi-fisheye
typedef Eigen::Matrix<float, 56, 56> Mat5656f;
typedef Eigen::Matrix<float, 57, 57> Mat5757f;

// double vectors
typedef Eigen::Matrix<double, CPARS, 1> VecC;
typedef Eigen::Matrix<double, 56, 1> Vec56;
typedef Eigen::Matrix<double, 26, 1> Vec26;
...
// multi-fisheye
typedef Eigen::Matrix<float, 56, 1> Vec56f;
typedef Eigen::Matrix<float, 57, 1> Vec57f;
