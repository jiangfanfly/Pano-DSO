...
namespace ldso {
    ...
    extern float setting_maxShiftWeightTSphere;       // for multi-fisheye Sphere
    extern float setting_maxShiftWeightRSphere;
    extern float setting_maxShiftWeightRTSphere;
