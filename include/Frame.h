...
namespace ldso {
    ...
    struct Point;  // If the depth of this Feature is correctly estimated, it will produce a corresponding Point 
    ...
    public:
         ...
         * Constructro with timestamp
         * @param timestamp
         * @param UndistortMultiFisheye
         */
        Frame(double timestamp, UndistortMultiFisheye* u);
        ...
        // for multi-fisheye
        void CreateFH(shared_ptr<Frame> frame, UndistortMultiFisheye* u);
    ...
    public:
        ...
        // for multi-fisheye
        vector<cv::Mat> vimgDisplay;
        UndistortMultiFisheye* UMF;
        vector<AffLight> vaff_g2l; // aff light transform from global to local
