...
namespace ldso {
    ...
    public:
        ...
        //===========
        //for multi-fisheye
        int DetectCornersforMF(int nFeatures, shared_ptr<Frame> &frame, int n, UndistortMultiFisheye* UMF);

        int ComputeDescriptorforMF(shared_ptr<Frame> &frame, shared_ptr<Feature> feat, UndistortMultiFisheye* UMF);
