...
namespace ldso {
    ...
    public:
        ...
        /**
         * select points from an input frame for multi-fisheye image
         * @param fh
         * @param camNum  the number of multi-fisheye camera
         * @param map_out an image of point selection, same size with the input image and value != 0 means the point is selected
         * // below is some parameters affecting the selection
         * @param density
         * @param recursionsLeft
         ...
         */
        int makeMapsforMF(
                const shared_ptr<FrameHessian> fh, int camNum, 
                float *map_out, float density, int recursionsLeft = 1, bool plot = false, float thFactor = 1);
        ...
        void makeHists(shared_ptr<FrameHessian> fh, int camNum);
    ...
    private:
        ...
        // for multi-fisheye image
        Eigen::Vector3i selectforMF(const shared_ptr<FrameHessian> fh, int camNum,
                               float *map_out, int pot, float thFactor = 1);
